...
- **[new-project](./new-project/SKILL.md)**: Start a new project: scaffold a folder, create the matching GitHub repo under the same name, and wire in the idea-to-ship config the engineering skills expect.
